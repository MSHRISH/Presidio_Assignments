...
namespace PizzaApi.Services
{
    public class UserAuthServices : IUserAuthServices
    {
        ...
        public UserAuthServices(IRepository<int,User> userRepository,IRepository<int,Authentication> authRepository,ITokenService tokenService) 
        {
            _userRepository = userRepository;
            _authRepository=authRepository;
            _tokenService=tokenService;
        }
        public async Task<LoginReturnDTO> Login(LoginUserDTO loginDTO)
        {
