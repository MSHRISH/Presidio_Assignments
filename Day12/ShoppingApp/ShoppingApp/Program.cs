    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            Cart CustomerCart = _shoppingServices.CreateCart(CustomerId);
            ...
            //Add Products
            var product=_shoppingServices.AddProductDraft(1, 200, "Prod A", 5);
            product=_shoppingServices.AddProductDraft(2, 500, "Prod B", 3);
            product=_shoppingServices.AddProductDraft(3, 50, "Prod C", 5);
            product = _shoppingServices.AddProductDraft(4, 100, "Prod D", 6);

            //Creating Cart And Testing
            _shoppingServices.AddToCart(CartId, 3, 1);

            var CheckoutCart= _shoppingServices.GetCartCheckoutDetails(CartId);
